...
func _physics_process(delta: float) -> void:
	...
	if Global.lvl_1:
		if Input.is_action_just_pressed("Next Age") and Global.stone_age:
			medieval_age()
		if Input.is_action_just_pressed("Prev Age") and Global.stone_age:
			medieval_age()
		if Input.is_action_just_pressed("Next Age") and Global.medieval_age:
			stone_age()
		if Input.is_action_just_pressed("Prev Age") and Global.medieval_age:
			stone_age()
